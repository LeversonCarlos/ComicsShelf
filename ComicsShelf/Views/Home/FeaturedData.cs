...
namespace ComicsShelf.Views.Home
{
   public class FeaturedData : Views.Home.LibraryData
   {
      public FeaturedData() : base(new Helpers.Database.ComicFolder { Key = "FEATURED", Text = R.Strings.HOME_FEATURED_PAGE_TITLE })
      {
         ...
         readingFilesData.Files.CollectionChanged += (object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e) =>
         { readingFilesData.HasFiles = readingFilesData.Files.Count != 0; };
         ...
         recentFilesData.Files.CollectionChanged += (object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e) =>
         { recentFilesData.HasFiles = recentFilesData.Files.Count != 0; };
         ...
         topRatedFilesData.Files.CollectionChanged += (object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e) =>
         { topRatedFilesData.HasFiles = topRatedFilesData.Files.Count != 0; };
