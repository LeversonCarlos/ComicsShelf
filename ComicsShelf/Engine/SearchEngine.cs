...
namespace ComicsShelf.Engine
{
   internal class Search : BaseEngine, IDisposable
   {
      ...
      #region Execute
      public static async Task Execute(Libraries.Library library, bool deepSearch)
      {
         ...
         try
         {
            ...
            using (var engine = new Search(library))
            {
               ...
               Engine.Statistics.Execute(library);
               if (deepSearch) { Engine.SyncLibrary.Save(library); }
            }
      ...
      #region Constructor
      public Search(Libraries.Library library) : base(library.LibraryID)
      {
      ...
      private Libraries.ILibraryService libraryService { get; set; }
      ...
      private async Task InitializeData()
      {
         try
         {
            ...
            */
            ...
            // LIBRARY SERVICE
            this.libraryService = Libraries.LibraryService.Get(this.library);
      ...
      #region SyncComicFiles
      private async Task SyncComicFiles()
      {
         try
         {
            // this.Notify(R.Strings.SEARCH_ENGINE_SEARCHING_COMIC_FILES_MESSAGE);
            ...
            if (remoteFiles == null || remoteFiles.Count == 0) { return; }
            ...
            foreach (var remoteFile in remoteFiles)
            {
               ...
               comicFile.ReadingPage = remoteFile.ReadingPage;
